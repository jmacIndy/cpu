...
int main(void)
{
   ...
   memory.write(0x16, 0x01); // LDR0 0x0A
   memory.write(0x17, 0x0A);
   memory.write(0x18, 0x04); // STORE 0x02
   memory.write(0x19, 0x02);
   memory.write(0x1A, 0x05); // PRT 0x02
   memory.write(0x1B, 0x02);
   memory.write(0x1C, 0x17); // DEC0
   memory.write(0x1D, 0x12); // JNZ 0x18
   memory.write(0x1E, 0x18);
   memory.write(0x1F, 0x0F); // RET
